...
import { BoxBlock, OtherBlock, BoxSizing } from '@views/box/block/block'
  ...
  return (
    <div className="Home">
          ...
          <section>
            ...
            <nav>
              <ul>
                ...
                <li><a href="/chapter3/boxSizing">box-sizing</a></li>
              </ul>
            </nav>
          </section>
        </article>
      ...
      <Routes>
        ...
        <Route path='/chapter3/boxSizing' element={<BoxSizing/>}></Route>
